...
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `2_gen_plan/` — 3 task(s)
      - `chat/messages/2_test_idea/round_1/2_gen_plan/gen_plan_dataset_1.md` — 9 messages
    ...
    - `3_gen_art/` — 3 task(s)
      - `chat/messages/2_test_idea/round_1/3_gen_art/gen_art_dataset_1.md` — 77 messages
      - `chat/messages/2_test_idea/round_1/3_gen_art/gen_art_evaluation_1.md` — 98 messages
      - `chat/messages/2_test_idea/round_1/3_gen_art/gen_art_experiment_1.md` — 56 messages
    - `chat/messages/2_test_idea/round_1/4_gen_paper_text.md` — 35 messages
    - `chat/messages/2_test_idea/round_1/5_review_paper.md` — 17 messages
  ...
  - round_2
    ...
    - `2_gen_plan/` — 2 task(s)
      ...
      - `chat/messages/2_test_idea/round_2/2_gen_plan/gen_plan_experiment_1.md` — 15 messages
    - `3_gen_art/` — 2 task(s)
      - `chat/messages/2_test_idea/round_2/3_gen_art/gen_art_evaluation_1.md` — 71 messages
      - `chat/messages/2_test_idea/round_2/3_gen_art/gen_art_experiment_1.md` — 82 messages
...
- **3. report_results** — `gen_paper_repo`
  - `1_gen_viz/` — 4 task(s)
    - `chat/messages/3_report_results/1_gen_viz/gen_viz_1.md` — 31 messages
    - `chat/messages/3_report_results/1_gen_viz/gen_viz_2.md` — 45 messages
    - `chat/messages/3_report_results/1_gen_viz/gen_viz_3.md` — 43 messages
    - `chat/messages/3_report_results/1_gen_viz/gen_viz_4.md` — 40 messages
  - `2_gen_demo_art/` — 5 task(s)
    ...
    - `chat/messages/3_report_results/2_gen_demo_art/gen_demo_art_evaluation_2.md` — 53 messages
    - `chat/messages/3_report_results/2_gen_demo_art/gen_demo_art_experiment_1.md` — 83 messages
    - `chat/messages/3_report_results/2_gen_demo_art/gen_demo_art_experiment_2.md` — 57 messages
  - `chat/messages/3_report_results/3_gen_full_paper.md` — 91 messages
